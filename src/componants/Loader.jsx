...
const Loader = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-linear-to-br from-slate-950 via-slate-900 to-black  z-9999">
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-gray-400 text-sm">Loading your response</p>
      </div>
    </div>
  );
};
